	...
	<div class="header-top">
		<div class="container">
				<div class="col-sm-4 logo animated wow fadeInLeft" data-wow-delay=".5s">
					<h1><a href="index.html"><img src="{{asset('images/Dr_2.png')}}" style="width:150px;"></a></h1>	
				</div>
			...
			<div class="col-sm-2 number animated wow fadeInRight" data-wow-delay=".5s">
					<span><i class="glyphicon glyphicon-phone"></i><a href="tel:+918981527733">+918981527733</a></span>
				...
				<div class="search-top">
						<div class="login">
							<form action="#" method="post">
								...
								<input type="text" name="search" value="What are you seeking?..." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}">		
