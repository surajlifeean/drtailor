	...
	<div class="header-top">
		<div class="container">
				<div class="col-sm-4 logo animated wow fadeInLeft" data-wow-delay=".5s">
					<h1><a href="index.html"><img src="{{asset('images/Dr_2.png')}}" style="width:200px;"></a></h1>	
				</div>
...
<div class="footer">
	<div class="container">
		...
		<div class="container">
				...
				<div class="clearfix"> </div>
				<p class="footer-class animated wow fadeInUp animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;"> © {{date('Y')}} Doctor Tailor . All Rights Reserved | Design by <a href="http://w3layouts.com/" target="_blank">Aida Labs India</a> </p>
			</div>
	</div>
</div>
<!--footer-->
